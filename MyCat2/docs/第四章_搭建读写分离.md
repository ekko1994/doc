...
```mysql
/*+ mycat:createDataSource{ "name":"rwSepw","url":"jdbc:mysql://192.168.48.222:3306/atguigu_master_slave?useSSL=false&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true", "user":"root","password":"root" } */;

/*+ mycat:createDataSource{ "name":"rwSepr","url":"jdbc:mysql://192.168.48.20:3306/atguigu_master_slave?useSSL=false&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true", "user":"root","password":"root" } */;
